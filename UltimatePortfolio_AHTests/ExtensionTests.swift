...
//
//  Created by Andy Heredia on 8/9/25.
//
import CoreData
import XCTest
...
final class ExtensionTests: BaseTestCase {
    func testIssueTitleUnwrap() {
        ...
        XCTAssertEqual(issue.issueTitle, "Example issue", "Chaging title should also change issueTitle")
        
        issue.title = "Updated issue"
        XCTAssertEqual(issue.issueTitle, "Updated issue", "Chaging title should also change issueTitle")
    }
    ...
    func testIssueContentUnwrap() {
        ...
        XCTAssertEqual(issue.issueContent, "Example issue", "Chaging title should also change issueContent")
        
        issue.issueContent = "Updated issue"
        XCTAssertEqual(issue.content, "Updated issue", "Chaging issueContent should also change issueTitle")
    }
    ...
    func testIssueCreationDateUnwrap() {
        ...
        // Then
        XCTAssertEqual(issue.issueCreationDate, testDate, "Chaging creationDate should also change issueCreationDate")
    ...
    func testIssueSortingIsStable() {
        ...
        XCTAssertEqual([issue3, issue1, issue2], sorted, "Sorting issue arrays should usue name then creation date.")
    }
